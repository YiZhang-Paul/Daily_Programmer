...
func TestFastFlip(t *testing.T) {
	cases := []struct {
		...
		{"001011011101001001000", "2 5 8 11 17 1 3 6 10 12 13 15 16 18 19 4 7 9 14 0 20"},
		...
		{"010111111111100100101000100110111000101111001001011011000011000", "1 4 6 8 10 12 18 24 28 31 36 39 41 47 50 53 59 2 13 14 16 17 19 21 22 23 25 26 29 33 34 35 37 42 43 45 46 48 51 54 55 56 57 60 61 3 5 7 9 11 15 20 27 30 32 38 40 44 49 52 58 0 62"},
	}
	for _, c := range cases {
